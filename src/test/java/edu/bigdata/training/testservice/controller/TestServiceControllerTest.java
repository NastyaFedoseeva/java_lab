...
public class TestServiceControllerTest {
    ...
    @Test
    public void update_should_change_name_of_PersonEntity_in_cache() throws Exception {
        PersonEntity personEntity = entityUtils.createAndSavePersonEntity();
        String newName = "newNAme";
        String argJson = objectMapper.writeValueAsString(newName);
    ...
    @Test
    public void delete_should_remove_PersonEntity_from_cache() throws Exception {
        PersonEntity personEntity = entityUtils.createAndSavePersonEntity();
